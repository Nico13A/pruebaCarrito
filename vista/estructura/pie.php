                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md">
                        ...
                        <ul class="list-unstyled text-small">
                            <li><a class="link-secondary" href="#">Antinao Nicolas</a></li>
                            <li><a class="link-secondary" href="#">Payllalef Alfredo</a></li>
                            <li><a class="link-secondary" href="#">Retamal Ezequiel</a></li>
                            <li><a class="link-secondary" href="#">Vasile Enzo</a></li>
                        </ul>
                    </div>
                </div>
            </div>
